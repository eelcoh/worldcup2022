...
import Bets.Init.Lib exposing (groupMatch)
...
matches =
    let
        t =
            tournament
    in
    { m01 = groupMatch t.a1 t.a2 (date 2020 Jun 12) (time 17 0) rome
    , m02 = groupMatch t.a3 t.a4 (date 2020 Jun 13) (time 15 0) baku
    , m14 = groupMatch t.a1 t.a3 (date 2020 Jun 17) (time 20 0) rome
    , m13 = groupMatch t.a4 t.a2 (date 2020 Jun 17) (time 17 0) baku
    , m26 = groupMatch t.a4 t.a1 (date 2020 Jun 21) (time 16 0) rome
    , m25 = groupMatch t.a2 t.a3 (date 2020 Jun 21) (time 16 0) baku

    --grop b
    , m03 = groupMatch t.b1 t.b2 (date 2020 Jun 13) (time 20 0) petersburg
    , m04 = groupMatch t.b3 t.b4 (date 2020 Jun 13) (time 17 0) kopenhagen
    , m15 = groupMatch t.b1 t.b3 (date 2020 Jun 17) (time 14 0) petersburg
    , m16 = groupMatch t.b4 t.b2 (date 2020 Jun 18) (time 20 0) kopenhagen
    , m28 = groupMatch t.b4 t.b1 (date 2020 Jun 22) (time 20 0) petersburg
    , m27 = groupMatch t.b2 t.b3 (date 2020 Jun 22) (time 20 0) kopenhagen

    --grop c
    , m05 = groupMatch t.c1 t.c2 (date 2020 Jun 14) (time 12 0) amsterdam
    , m06 = groupMatch t.c3 t.c4 (date 2020 Jun 14) (time 18 0) boekarest
    , m17 = groupMatch t.c4 t.c2 (date 2020 Jun 18) (time 14 0) amsterdam
    , m18 = groupMatch t.c1 t.c3 (date 2020 Jun 18) (time 17 0) boekarest
    , m29 = groupMatch t.c4 t.c1 (date 2020 Jun 22) (time 16 0) amsterdam
    , m30 = groupMatch t.c2 t.c3 (date 2020 Jun 22) (time 16 0) boekarest

    --grop d
    , m07 = groupMatch t.d1 t.d2 (date 2020 Jun 14) (time 15 0) londen
    , m08 = groupMatch t.d3 t.d4 (date 2020 Jun 15) (time 21 0) glasgow
    , m20 = groupMatch t.d1 t.d3 (date 2020 Jun 19) (time 20 0) londen
    , m19 = groupMatch t.d4 t.d2 (date 2020 Jun 19) (time 17 0) glasgow
    , m32 = groupMatch t.d4 t.d1 (date 2020 Jun 23) (time 20 0) londen
    , m31 = groupMatch t.d2 t.d3 (date 2020 Jun 23) (time 20 0) glasgow

    --grop e
    , m09 = groupMatch t.e3 t.e4 (date 2020 Jun 15) (time 14 0) bilbao
    , m10 = groupMatch t.e1 t.e2 (date 2020 Jun 15) (time 20 0) dublin
    , m22 = groupMatch t.e4 t.e2 (date 2020 Jun 20) (time 20 0) bilbao
    , m21 = groupMatch t.e1 t.e3 (date 2020 Jun 19) (time 14 0) dublin
    , m33 = groupMatch t.e4 t.e1 (date 2020 Jun 24) (time 20 0) bilbao
    , m34 = groupMatch t.e2 t.e3 (date 2020 Jun 24) (time 20 0) dublin

    --grop f
    , m12 = groupMatch t.f1 t.f2 (date 2020 Jun 16) (time 17 0) munchen
    , m11 = groupMatch t.f3 t.f4 (date 2020 Jun 16) (time 14 0) boekarest
    , m24 = groupMatch t.f4 t.f2 (date 2020 Jun 20) (time 17 0) munchen
    , m23 = groupMatch t.f1 t.f3 (date 2020 Jun 20) (time 20 0) boekarest
    , m36 = groupMatch t.f4 t.f1 (date 2020 Jun 24) (time 16 0) munchen
    , m35 = groupMatch t.f2 t.f3 (date 2020 Jun 24) (time 16 0) boekarest
    }
